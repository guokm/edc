...
tasks.register<JavaExec>("runCommercialScenario") {
    group = "verification"
    description = "Run EDC commercial scenario with two data planes and PostgreSQL persistence"
    classpath = sourceSets["test"].runtimeClasspath
    mainClass.set("org.eclipse.edc.test.e2e.CommercialDataspaceScenarioRunner")
}
